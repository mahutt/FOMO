/* 
  Piezo buzzer controller functions for use in the FOMO system.
  Based on code written by Robson Couto, 2019
...
Song notification = {
  notificationMelody,
  sizeof(notificationMelody) / sizeof(notificationMelody[0]),
  114
};
